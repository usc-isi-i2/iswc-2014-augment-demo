\begin{enumerate}
\item CSV file from a museum, containing 2500 records of artworks by 200 \todo{exact number?} artists.
...
In previous work~\todo{cite SAAM paper, saam-lod github} we mapped the SAAM dataset to the CIDOC CRM ontology~\cite{Doerr:2003:CCR:958671.958678}, producing a collection of \rtworml mapping files for 14 tables in the SAAM collection management system.
