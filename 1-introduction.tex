...
Our approach, implemented as a new capability in our \karma data integration system~\cite{knoblock12:eswc} leverages \rtworml mappings \todo{CITE R2RML} to accurately describe the contents of the user's datasets and the contents of datasets in the Linked Data cloud.
...
Even though the \rtworml standard was defined to specify mappings from relational databases to RDF recent work \todo{cite RML} has proposed extensions to specify mappings from other types of data including CSV, JSON, XML and Web APIs.
