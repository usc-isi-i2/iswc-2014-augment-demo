...
\usepackage{url}
\urldef{\mailsa}\path|{slepicka, szekely, knoblock}@isi.edu|
...
\titlerunning{Augmenting Data Using Sources Models}
...
%
\authorrunning{Augmenting Data Using Sources Models}
